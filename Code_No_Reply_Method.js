function sendMessages(){  
  //Users will get a no replay corresponding email when they want to send messages. 
   ...
   GmailApp.sendEmail(currentemail, subjectLine,messageBody,{'from':aliases[2], name:"Team Voice Message",htmlBody:message,noReply:true});
